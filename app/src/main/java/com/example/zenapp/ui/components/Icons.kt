package com.example.zenapp.ui.components
...
val Icons.Filled.ShieldCheck: ImageVector
    get() {
        if (_shieldCheck != null) {
            return _shieldCheck!!
        }
        _shieldCheck = materialIcon(name = "Filled.ShieldCheck") {
            materialPath {
                moveTo(12f, 1f)
                lineTo(3f, 5f)
...
val Icons.Filled.SettingsIcon: ImageVector
    get() {
        if (_settingsIcon != null) {
            return _settingsIcon!!
        }
        _settingsIcon = materialIcon(name = "Filled.Settings") {
            materialPath {
